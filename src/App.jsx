...
import {
  ...
  extendTheme, Text, Flex, Badge, Input, VStack, List, ListItem,
  Divider, Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon, Button, HStack
  ...
  return (
    <ChakraProvider theme={theme}>
      <Box
        minH="100vh"
        w="100vw"
        bgImage={`url("/indoor-climbing.PNG")`} // Vivid image, no overlay
        bgSize="cover"
        bgPosition="center"
        bgRepeat="no-repeat"
        display="flex"
      ...
      >
        <Box
          ...
          overflowY="auto"
        >
          {/* User info row (palette buttons removed) */}
          ...
          {/* ---- TABS ---- */}
          <Tabs isFitted variant="soft-rounded" colorScheme="ocean" size="lg" orientation="horizontal">
            ...
            <TabPanels>
              <TabPanel>
                ...
                <Divider mb={4} />
                <Text mb={2}>
                  Personalized tip: <i>Schedule a session focused on your biggest weakness for the fastest progress!</i>
                </Text>
              </TabPanel>
              ...
              <TabPanel>
                ...
                <Button mt={3} colorScheme="ocean" size="sm">Create/Join Squad (Premium)</Button>
              </TabPanel>
